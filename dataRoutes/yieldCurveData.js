...
// 2nd quarter of 2019 (201906); S&P500 Price=2941.76; i=4; GDPCompile=117.441; i=1
...
let inversions = [
	{
		...
		sp19: (((spPrice[28].price - spPrice[40].price) / spPrice[40].price ) * 100).toFixed(2) + "|",
		gdp19: (((gdp[9].gdpCompile / gdp[13].gdpCompile) - 1) * 100).toFixed(1)
	},{
		...
		sp19: (((spPrice[16].price - spPrice[28].price) / spPrice[28].price ) * 100).toFixed(2) + "|",
		gdp19: (((gdp[5].gdpCompile / gdp[9].gdpCompile) - 1) * 100).toFixed(1)
	},{
		...
		sp19: (((spPrice[4].price - spPrice[16].price) / spPrice[16].price ) * 100).toFixed(2) + "|",
		gdp19: (((gdp[1].gdpCompile / gdp[5].gdpCompile) - 1) * 100).toFixed(1)
	},{
