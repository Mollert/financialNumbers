...
// 3rd quarter of 2000 (200009); S&P500 Price=1436.51; i=230; GDPCompile=81.363; i=76
// 3rd quarter of 2006 (200609); S&P500 Price=1335.85; i=158; GDPCompile=94.625; i=52
// 3rd quarter of 2019 (201909); S&P500 Price=2976.74; i=2; GDPCompile=118.000; i=0
...
let inversions = [
	{
		...
		sp00: (((spPrice[254].price - spPrice[266].price) / spPrice[266].price ) * 100).toFixed(2) + "|",
		gdp00: (((gdp[84].gdpCompile / gdp[88].gdpCompile) - 1) * 100).toFixed(1),
		sp06: (((spPrice[182].price - spPrice[194].price) / spPrice[194].price ) * 100).toFixed(2) + "|",
		gdp06: (((gdp[60].gdpCompile / gdp[64].gdpCompile) - 1) * 100).toFixed(1),
		sp19: (((spPrice[26].price - spPrice[38].price) / spPrice[38].price ) * 100).toFixed(2) + "|",
		gdp19: (((gdp[8].gdpCompile / gdp[12].gdpCompile) - 1) * 100).toFixed(1)
	},{
		timePeriod: "2 Years Prior",
		sp00: (((spPrice[242].price - spPrice[254].price) / spPrice[254].price ) * 100).toFixed(2) + "|",
		gdp00: (((gdp[80].gdpCompile / gdp[84].gdpCompile) - 1) * 100).toFixed(1),
		sp06: (((spPrice[170].price - spPrice[182].price) / spPrice[182].price ) * 100).toFixed(2) + "|",
		gdp06: (((gdp[56].gdpCompile / gdp[60].gdpCompile) - 1) * 100).toFixed(1),
		sp19: (((spPrice[14].price - spPrice[26].price) / spPrice[26].price ) * 100).toFixed(2) + "|",
		gdp19: (((gdp[4].gdpCompile / gdp[8].gdpCompile) - 1) * 100).toFixed(1)
	},{
		timePeriod: "1 Year Prior",
		sp00: (((spPrice[230].price - spPrice[242].price) / spPrice[242].price ) * 100).toFixed(2) + "|",
		gdp00: (((gdp[76].gdpCompile / gdp[80].gdpCompile) - 1) * 100).toFixed(1),
		sp06: (((spPrice[158].price - spPrice[170].price) / spPrice[170].price ) * 100).toFixed(2) + "|",
		gdp06: (((gdp[52].gdpCompile / gdp[56].gdpCompile) - 1) * 100).toFixed(1),
		sp19: (((spPrice[2].price - spPrice[14].price) / spPrice[14].price ) * 100).toFixed(2) + "|",
		gdp19: (((gdp[0].gdpCompile / gdp[4].gdpCompile) - 1) * 100).toFixed(1)
	},{
		timePeriod: "1 Year After",
		sp00: sp00oneAfter =  (((spPrice[218].price - spPrice[230].price) / spPrice[230].price ) * 100).toFixed(2) + "|",
		gdp00: (((gdp[72].gdpCompile / gdp[76].gdpCompile) - 1) * 100).toFixed(1),
		sp06: sp06oneAfter =  (((spPrice[146].price - spPrice[158].price) / spPrice[158].price ) * 100).toFixed(2) + "|",
		gdp06: (((gdp[48].gdpCompile / gdp[52].gdpCompile) - 1) * 100).toFixed(1),
		sp19: "-|",
		gdp19: "-"
	},{
		timePeriod: "2 Years After",
		sp00: (((spPrice[206].price - spPrice[218].price) / spPrice[218].price ) * 100).toFixed(2) + "|",
		gdp00: (((gdp[68].gdpCompile / gdp[72].gdpCompile) - 1) * 100).toFixed(1),
		sp06: (((spPrice[134].price - spPrice[146].price) / spPrice[146].price ) * 100).toFixed(2) + "|",
		...
		sp06: (((spPrice[122].price - spPrice[134].price) / spPrice[134].price ) * 100).toFixed(2) + "|",
